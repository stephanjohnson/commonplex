...
"));
        ...
        {
            Assert.Equal(@"<p>\<em>emphasis</em></p>
", GetHtml(@"\\*emphasis*
"));
        }
...
"));
        ...
        {
            Assert.Equal(@"<p><a href=""http://example.com?find=%5C*"">http://example.com?find=\*</a></p>
", GetHtml(@"<http://example.com?find=\*>
"));
        }
...
"));
        ...
        {
            Assert.Equal(@"<p><a href=""/bar*"" title=""ti*tle"">foo</a></p>
", GetHtml(@"[foo](/bar\* ""ti\*tle"")
"));
        }
