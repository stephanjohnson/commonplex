...
"));
        ...
        {
            Assert.Equal(@"<p><code>foo ` bar</code></p>
", GetHtml(@"`` foo ` bar  ``
"));
        }
...
"));
        ...
        {
            Assert.Equal(@"<p><code>foo bar baz</code></p>
", GetHtml(@"`foo   bar
  baz`
"));
        }
...
"));
        ...
        {
            Assert.Equal(@"<p><code>foo\</code>bar`</p>
", GetHtml(@"`foo\`bar`
"));
        }
        ...
        {
            Assert.Equal(@"<p>*foo<code>*</code></p>
", GetHtml(@"*foo`*`
"));
        }
        ...
        {
            Assert.Equal(@"<p>[not a <code>link](/foo</code>)</p>
", GetHtml(@"[not a `link](/foo`)
"));
        }
        ...
        {
            Assert.Equal(@"<p><code>&lt;a href=&quot;</code>&quot;&gt;`</p>
", GetHtml(@"`<a href=""`"">`
"));
        }
...
"));
        ...
        {
            Assert.Equal(@"<p><code>&lt;http://foo.bar.</code>baz&gt;`</p>
...
"));
        ...
        {
            Assert.Equal(@"<p><a href=""http://foo.bar.%60baz"">http://foo.bar.`baz</a>`</p>
", GetHtml(@"<http://foo.bar.`baz>`
"));
        }
